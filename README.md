...
- [기획서 v0.5](AX_Day_2026_Boardroom_Plan.md)
...
2026-09-09 검토 반영: AI 자동 정리 상시 표시, 찬성·반대 양방향 결정 경로, 세 안건 구조화, 무입력90초 복귀와 현장 검수 기준. 최신 구현 지시서는 v1.2입니다. PPT·이미지는 시각 레퍼런스이며 최신 문서의 동작·수량·비실사 아바타 기준을 우선합니다.
