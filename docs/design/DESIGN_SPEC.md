...
| 반응 | 내 발언 카드 아래 임원 반응을 답글형(들여쓰기·연결선)으로, 변한 임원만 강조 → “CIO가 묻습니다” 질문 + 빠른 답 3개 → ‘직접 답하기’(접힘) | 빠른 답만으로 마무리 가능. 직접 답하기를 열면 300자 입력과 조건 칩이 나타난다 |
