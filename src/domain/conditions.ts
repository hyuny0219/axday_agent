...
// 초성 ㄷ+ㅚ/ㅙ 음절은 되~됳·돼~됗 범위다. 앞 글자 조건은 "어절 시작"(18차) → "조사 허용"(23차)을
// 거쳐, 조사를 열거하면 '조차·마저·부터·까지·밖에'가 빠지므로(24차) 반대로 **'안'이 부정이 아닌
// 낱말의 앞 글자만 제외**한다: 불안·미안·보안·편안·평안·동안·위안·치안. 그 밖의 어떤 글자 뒤든
// '안' + 하다·되다 활용은 부정이다 — "검수는안할게요"·"검수조차안할게요"·"확인부터안하고" 모두
// 부정, "불안하면"·"미안하지만"·"보안해야"는 아니다. '안내·안전·안정·안심'은 '안' 뒤 음절이
// ㅎ·되 계열이 아니라 애초에 걸리지 않는다.
const AN_NEGATION = /(?<![불미보편평동위치])안(?:\s|[하-힣]|[되-됳돼-됗])/;
