...
export const anonBoardScenario: Scenario = {
  ...
  briefingSummary: {
    text: '실명 320건과 익명 시범 140건은 집계 기간과 참여 범위가 다릅니다. 같은 기준으로 확인하기 전에는 어느 쪽이 더 활발한지 판단할 수 없습니다. 신고 처리 담당자는 아직 지정돼 있지 않습니다(운영 회의록). 로그 보관 기간과 작성자 추적 권한은 설계 중입니다(정보보호 메모).',
